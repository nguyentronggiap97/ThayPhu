...
<main id="maincontent" role="main">
	...
	<?php if( get_theme_mod('vw_lawyer_attorney_slider_hide_show',true) != ''){ ?>
	  	<section class="slider">
		    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
		          ...
		          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
		            ...
		            <div class="carousel-caption">
		              <div class="inner_carousel">
		                <h2><?php the_title(); ?></h2>
		                <p><?php $excerpt = get_the_excerpt(); echo esc_html( vw_lawyer_attorney_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_lawyer_attorney_slider_excerpt_number','30')))); ?></p>
		                <div class ="testbutton">
			                <a class="hvr-sweep-to-right" href="<?php the_permalink(); ?>"><?php esc_html_e('KNOW MORE','vw-lawyer-attorney'); ?><span class="screen-reader-text"><?php esc_html_e( 'KNOW MORE','vw-lawyer-attorney' );?></span></a>
			            </div>
		              </div>
		            </div>
		          </div>
		      ...
		      <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
		        ...
		        <span class="screen-reader-text"><?php esc_attr_e( 'Previous','vw-lawyer-attorney' );?></span>
		      </a>
		      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
		        <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-arrow-right"></i></span>
		        <span class="screen-reader-text"><?php esc_attr_e( 'Next','vw-lawyer-attorney' );?></span>
		      </a>
		    </div>  
		        	...
		        	if($postData1){
				      ...
				      if ( $query->have_posts() ) :
				        while ( $query->have_posts() ) : $query->the_post(); ?>
				            <h3><?php the_title(); ?></h3>
				            <p><?php $excerpt = get_the_excerpt(); echo esc_html( vw_lawyer_attorney_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_lawyer_attorney_about_excerpt_number','30')))); ?></p>
				            <?php if( get_theme_mod('vw_lawyer_attorney_about_name') != ''){ ?>
				            <div class ="testbutton">
				              <a class="hvr-sweep-to-right" href="<?php the_permalink(); ?>"><?php echo esc_html(get_theme_mod('vw_lawyer_attorney_about_name','')); ?><span class="screen-reader-text"><?php esc_html_e( 'Discover More About Us','vw-lawyer-attorney' );?></span></a>
				            </div>
				            <?php }?>
				        <?php endwhile; 
				        wp_reset_postdata();?>
				  			...
				  			<div class="why-box">
					  			<div class="row m-0">
							    	...
							    	<div class="col-lg-9 col-md-9">
							    		...
							    		<p><?php $excerpt = get_the_excerpt(); echo esc_html( vw_lawyer_attorney_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_lawyer_attorney_choose_excerpt_number','30')))); ?></p>
							    	</div>
							    </div>
							</div>
					    	<div class="clearfix"></div>

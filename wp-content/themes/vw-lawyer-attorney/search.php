    ...
    <div class="middle-align container">
        <?php
            ...
            if($theme_lay == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8 ">
                       <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-lawyer-attorney'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                        <?php if ( have_posts() ) :
                        /* Start the Loop */
            ...
            <?php }else if($theme_lay == 'Right Sidebar'){ ?>
                <div class="row">
                    <section id="our-services" class="services col-lg-8 col-md-8 ">
                        <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-lawyer-attorney'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
                        <?php if ( have_posts() ) :
                        /* Start the Loop */

...
function vw_lawyer_attorney_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-lawyer-attorney' ) .'</h3>';
...
function vw_lawyer_attorney_scripts() {
	...
	wp_enqueue_script('vw-lawyer-attorney-customs-jquery', get_template_directory_uri().'/js/custom.js', array('jquery'));
...
define('VW_LAWYER_ATTORNEY_FREE_THEME_DOC', 'https://www.vwthemesdemo.com/docs/free-vw-lawyer-attorney/', 'vw-lawyer-attorney');
define('VW_LAWYER_ATTORNEY_SUPPORT', 'https://wordpress.org/support/theme/vw-lawyer-attorney/', 'vw-lawyer-attorney');
define('VW_LAWYER_ATTORNEY_REVIEW', 'https://wordpress.org/support/theme/vw-lawyer-attorney/reviews/', 'vw-lawyer-attorney');
...
define('VW_LAWYER_ATTORNEY_PRO_DOC', 'https://www.vwthemesdemo.com/docs/vw-lawyer-attorney-pro/', 'vw-lawyer-attorney');
...
define('VW_LAWYER_ATTORNEY_CREDIT', 'https://www.vwthemes.com/themes/free-lawyer-wordpress-theme/', 'vw-lawyer-attorney');

if (!function_exists('vw_lawyer_attorney_credit')) {
	function vw_lawyer_attorney_credit() {
		echo "<a href=".esc_url(VW_LAWYER_ATTORNEY_CREDIT).">".esc_html('Lawyer WordPress Theme', 'vw-lawyer-attorney')."</a>";
	}
}

function vw_lawyer_attorney_sanitize_dropdown_pages( $page_id, $setting ) {
...
add_filter('loop_shop_columns', 'vw_lawyer_attorney_loop_columns');
	if (!function_exists('vw_lawyer_attorney_loop_columns')) {
		function vw_lawyer_attorney_loop_columns() {
		return 3; // 3 products per row
	}
}

/* Excerpt Limit Begin */
function vw_lawyer_attorney_string_limit_words($string, $word_limit) {

...
if ( ! class_exists( 'VW_Lawyer_Attorney_Content_Creation' ) ) :

	/**
	 * VW_Lawyer_Attorney_Content_Creation class.
	 */
	class VW_Lawyer_Attorney_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Lawyer_Attorney_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Lawyer_Attorney_Content_Creation' );
